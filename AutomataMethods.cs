...
{
    class AutomataMethods
    {
        public void RunAutomata(int length, int generations, bool[] ruleToApply)
        {
        ...
        public bool[] applyRule(bool[] previousRow, bool[] condition)
        {
